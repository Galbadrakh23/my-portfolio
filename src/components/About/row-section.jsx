const RowSection = () => {
  return (
    <div>
      <div className="w-[500px] lg:text-left lg:flex-1 max-w-2xl">
        ...
        <h2 className=" font-normal text-gray-600 mb-2">
          Finally, some quick bits about me:
        </h2>
        <ul className="list-disc list-inside mb-4 ffont-normal text-gray-600 flex flex-row gap-10">
          <li>B.E. in Computer Engineering</li>
          <li>Avid learner</li>
        </ul>
        <li className="font-normal text-gray-600">Full time freelancer</li>
